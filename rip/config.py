...
class Config:
    ...
    def qobuz_creds(self):
        ...
        return {
            "use_auth_token": self.file["qobuz"].get("use_auth_token", False),
            "email_or_userid": self.file["qobuz"].get("email_or_userid", ""),
            "password_or_token": self.file["qobuz"].get("password_or_token", ""),
